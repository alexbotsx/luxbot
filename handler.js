...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *BOTLUX*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *BOTLUX*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *BOTLUX*.`,
